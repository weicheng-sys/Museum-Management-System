...
def main():
    baseurl = "https://baike.baidu.com/item/%E6%96%B0%E7%96%86%E7%BB%B4%E5%90%BE%E5%B0%94%E8%87%AA%E6%B2%BB%E5%8C%BA%E5%8D%9A%E7%89%A9%E9%A6%86"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        opentime = re.findall(findOpenTime, item)[4]
        # print(opentime)

        ticket="免费(每天限量2000人入馆)"
        itemnumber ="3.2万件(号),其中一级品288件"
        itemtype="有丝毛棉麻织物 (包括锦、绮、绫、罗、纱、缦、绢、印染、刺绣等大量汉唐丝织品，毯、毡、绦带、刺绣等古代毛织品)，多种文字 (汉文、回鹘文、 佉卢文、吐火罗文、梵文、古和田文、吐蕃文、阿拉伯文、粟特文等) 书写的文书、简牍，晋唐时期木雕、泥塑俑像及纸本、绢本人物，花鸟绘画，具有斯基泰文化特征的青铜器，以及新疆各兄弟民族的服饰与工艺品。此外，还有部分古生物化石和古尸标本等。"
