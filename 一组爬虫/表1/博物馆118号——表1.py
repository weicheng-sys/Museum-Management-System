...
def main():
    baseurl = "https://baike.baidu.com/item/%E8%A5%BF%E5%AE%89%E5%8D%9A%E7%89%A9%E9%99%A2"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div',class_="main-content"):
        item=str(item)
        opentime = re.findall(findOpentime, item)[45]
