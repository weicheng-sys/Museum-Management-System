...
def main():
    baseurl = "https://baike.baidu.com/item/%E5%90%90%E9%B2%81%E7%95%AA%E5%8D%9A%E7%89%A9%E9%A6%86/4800605"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        # print(ticket)
    number="9"
    itemnumber="馆藏文物20637件，珍贵文物707件（其中一级文物120件，二级文物149件，三级文物438件）"
    itemtype="藏品类别有石器、陶器、泥塑、木器、铜器、铁器、金银器、文书、木雕、泥俑、绘画、古尸、粮食、干果及各类食品、泥塑、纺织品、干尸等35种。"
    data.append(name)
    data.append(place)
    data.append(type)
    data.append(number)
