...
def main():   #爬取数据，解析数据
    baseurl="https://baike.baidu.com/item/%E8%BE%BD%E5%AE%81%E7%9C%81%E5%8D%9A%E7%89%A9%E9%A6%86"
...
def getdata(baseurl):
         ...
         # 2.逐一解析数据
            ...
            Position=re.sub('\n', "", Position)  # 替换/
            Position = re.sub('<a data-lemmaid="739981" href="/item/%E8%BE%BD%E5%AE%81%E7%9C%81/739981" target="_blank">', "", Position)  # 替换/
            Position = re.sub('<a data-lemmaid="124784" href="/item/%E6%B2%88%E9%98%B3%E5%B8%82/124784" target="_blank">', "",Position)  # 替换/
            Position = re.sub('</a>', "", Position)  # 替换/
            ...
            opentime=re.findall(position,item)[4]  #提取博物馆开放时间
            opentime = re.sub('\n', " ", opentime)  # 替换/
