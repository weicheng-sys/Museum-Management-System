...
def main():
    baseurl = "https://baike.baidu.com/item/%E8%A5%BF%E5%AE%89%E5%8D%8A%E5%9D%A1%E5%8D%9A%E7%89%A9%E9%A6%86"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        ticket=re.findall(findTicket,item)[10]
        #print(ticket)
    ...
    for item in soup.find_all('div',class_="main-content"):
        ...
        itemnumber=re.findall(findItemNumber,item)[27][9:13]
        #print(itemnumber)

        itemtype=re.findall(findItemType,item)[27][23:87]
        #print(itemtype)

        opentime=re.findall(findOpentime,item)[59]+" "+re.findall(findOpentime,item)[60]
        #print(opentime)
