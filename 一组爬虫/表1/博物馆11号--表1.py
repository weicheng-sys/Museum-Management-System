...
def main():   #爬取数据，解析数据
    baseurl="https://baike.baidu.com/item/%E4%B8%AD%E5%9B%BD%E5%9B%BD%E5%AE%B6%E5%8D%9A%E7%89%A9%E9%A6%86"
...
def getdata(baseurl):
         ...
         # 2.逐一解析数据
            ...
            Position = re.sub('<a href="/item/%E5%8C%97%E4%BA%AC" target="_blank">', "", Position)  # 替换/
            Position=re.sub('\n', "", Position)  # 替换/
            ...
            ticket=re.findall(position,item)[13]  #提取博物馆门票
            ticket = re.sub('\n', " ", ticket)  # 替换/
            data.append(ticket)
