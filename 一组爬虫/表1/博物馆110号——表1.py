...
def main():
    baseurl = "https://baike.baidu.com/item/%E9%87%8D%E5%BA%86%E8%87%AA%E7%84%B6%E5%8D%9A%E7%89%A9%E9%A6%86/8022419"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        place = re.findall(findPlace, item)[7]
        #print(place)
    ...
    for item in soup.find_all('div',class_="main-content"):
        ...
        itemnumber=re.findall(findItemNumber,item)[2][6:11]
        #print(itemnumber)

        itemtype=re.findall(findItemType,item)[2][12:47]
        #print(itemtype)
    data.append(name)
    data.append(place)
    data.append(type)
