...
def main():
    baseurl = "https://baike.baidu.com/item/%E6%AD%A6%E6%B1%89%E4%B8%AD%E5%B1%B1%E8%88%B0%E5%8D%9A%E7%89%A9%E9%A6%86/692909?fromtitle=%E6%AD%A6%E6%B1%89%E5%B8%82%E4%B8%AD%E5%B1%B1%E8%88%B0%E5%8D%9A%E7%89%A9%E9%A6%86&fromid=23692987&fr=aladdin"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        time = re.findall(findTime, item)[7]
        # print(time)

        opentime = re.findall(findOpenTime, item)[4]
        # print(opentime)

        ticket = re.findall(findTicket, item)[6]
        # print(ticket)
    data.append(name)
    data.append(place)
    data.append(type)
