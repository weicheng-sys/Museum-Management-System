...
def main():   #爬取数据，解析数据
    baseurl="https://baike.baidu.com/item/%E5%91%A8%E6%81%A9%E6%9D%A5%E9%82%93%E9%A2%96%E8%B6%85%E7%BA%AA%E5%BF%B5%E9%A6%86"
...
def getdata(baseurl):
         ...
         # 2.逐一解析数据
            ...
            Position=re.findall(position,item)[6]   #提取博物馆位置
            Position=re.sub('\n', "", Position)  # 替换/
            ...
            ticket=re.findall(position,item)[4]  #提取博物馆门票
            ticket = re.sub('\n', " ", ticket)  # 替换/
            data.append(ticket)

            opentime=re.findall(position,item)[2]  #提取博物馆开放时间
            opentime = re.sub('\n', " ", opentime)  # 替换/
