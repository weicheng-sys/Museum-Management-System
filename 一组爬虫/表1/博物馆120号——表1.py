...
def main():
    baseurl = "https://baike.baidu.com/item/%E8%A5%BF%E5%AE%89%E5%A4%A7%E5%94%90%E8%A5%BF%E5%B8%82%E5%8D%9A%E7%89%A9%E9%A6%86/15717208"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        place = re.findall(findPlace, item)[4]
        # print(place)

        time = re.findall(findTime, item)[2]
        # print(time)
    data.append(name)
    data.append(place)
    data.append(type)
