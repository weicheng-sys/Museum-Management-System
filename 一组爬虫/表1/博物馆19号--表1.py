...
def main():   #爬取数据，解析数据
    baseurl="https://baike.baidu.com/item/%E8%A5%BF%E6%9F%8F%E5%9D%A1%E7%BA%AA%E5%BF%B5%E9%A6%86"
...
def getdata(baseurl):
         ...
         # 2.逐一解析数据
            ...
            print(Type)
            Type=re.sub('<a data-lemmaid="8744911" href="/item/%E5%8E%86%E5%8F%B2%E5%8D%9A%E7%89%A9%E9%A6%86/8744911" target="_blank">',"",Type)
            Type = re.sub('</a>', "", Type)  # 替换/
            Type = re.sub('\n', "", Type)  # 替换/
            data.append(Type)
            ...
            ticket=re.findall(position,item)[6]  #提取博物馆门票
            ticket = re.sub('\n', " ", ticket)  # 替换/
            data.append(ticket)
