...
def main():
    baseurl = "https://baike.baidu.com/item/%E5%AE%81%E5%A4%8F%E5%8D%9A%E7%89%A9%E9%A6%86"
    # 1.爬取网页
...
def getData(baseurl):
    ...
    for item in soup.find_all('div', class_="basic-info cmn-clearfix"):
        ...
        ticket = re.findall(findTicket, item)[5]
        # print(time)
    ...
    time="1959年9月"
    itemnumber="近4万件"
    itemtype="国家一级文物159件，三级以上珍贵文物4000余件"
