...
def main():   #爬取数据，解析数据
    baseurl="https://baike.baidu.com/item/%E5%91%A8%E5%8F%A3%E5%BA%97%E7%8C%BF%E4%BA%BA%E9%81%97%E5%9D%80%E5%8D%9A%E7%89%A9%E9%A6%86"
...
def getdata(baseurl):
         ...
         # 2.逐一解析数据
            ...
            Time=  re.findall(position, item)[3]#提取博物馆建馆时间
            Time = re.sub('\n', " ", Time)  # 替换/
            data.append(Time)
            ...
            #opentime=re.findall(position,item)[12]  #提取博物馆开放时间
            #opentime= re.sub('\n', " ", opentime)  # 替换/
            data.append("")
