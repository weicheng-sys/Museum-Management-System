      ...
      <el-col :span="24">
        <el-form ref="form" :model="form" :rules="rules" label-width="130px">
          ...
          <el-form-item label="用户组">
            <el-select v-model="selectedGroups" multiple placeholder="请选择" class="h-40 w-200">
              <el-option v-for="item in groupOptions" :key="item.else" :value="item.else" :label="item.else" class="form-checkbox">
              </el-option>
            </el-select>
          </el-form-item>
        </el-form>
