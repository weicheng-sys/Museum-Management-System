...
import informationList from './components/Administrative/member/information/list.vue'
import informationAdd from './components/Administrative/member/information/add.vue'
import informationEdit from './components/Administrative/member/information/edit.vue'
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'information/list', component: informationList, name: 'informationList', meta: { hideLeft: false, module: 'Administrative', menu: 'information' }},
      { path: 'information/add', component: informationAdd, name: 'informationAdd', meta: { hideLeft: false, module: 'Administrative', menu: 'information' }},
      { path: 'information/edit/:id', component: informationEdit, name: 'informationEdit', meta: { hideLeft: false, module: 'Administrative', menu: 'information' }}
    ]
  }
]
